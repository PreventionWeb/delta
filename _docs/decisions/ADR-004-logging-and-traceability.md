...
- **Logging** answers _what happened_ — a record of events with context at a point in time.
- **Tracing** answers _how a request flowed_ — the full journey of one request, correlating all related log lines into a single timeline.
