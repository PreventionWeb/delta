			...
			<div className="max-h-[calc(100vh-2rem)] w-full max-w-6xl overflow-y-auto rounded-xl bg-white p-5 shadow-xl">
				<div className="mb-4 flex items-center justify-between">
					<h3 className="text-[18px] font-semibold text-slate-800">
						{ctx.t({
							code: "disaster_event.form.manage_linked_triggering_hazardous_events",
							msg: "Manage linked triggering (causal) hazardous events",
						})}
					</h3>
					<Button
						type="button"
				...
				<p className="mb-4 text-[13px] text-slate-500">
					{ctx.t({
						...
						msg: "Search and select hazardous events that causally triggered this disaster event.",
					})}
				</p>
				...
				<div className="grid gap-4 md:grid-cols-2">
					...
					<div className="rounded-xl border border-slate-200 bg-white p-4">
						<div className="mb-3 flex items-center justify-between gap-2">
							<h4 className="text-[14px] font-semibold text-slate-800">
								{ctx.t({
									code: "disaster_event.form.selected_triggering_hazardous_events",
						...
						<div className="max-h-[50vh] overflow-y-auto pr-1">
							<DataView
								...
								emptyMessage={ctx.t({
									code: "disaster_event.form.no_triggering_hazardous_events_linked",
