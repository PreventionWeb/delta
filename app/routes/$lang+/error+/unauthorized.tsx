...
export default function UnauthorizedError() {
	...
	switch (reason) {
		...
		case "no_edit_permission":
			...
			errorDetails =
				"This action requires 'Edit Data' permission. Please contact your administrator if you believe you should have access.";
			break;
		...
		case "no_delete_permission":
			...
			errorDetails =
				"This action requires 'Delete Validated Data' permission. Please contact your administrator if you believe you should have access.";
			break;
		...
		case "parent_record_not_found":
			...
			errorMessage =
				"The parent record does not exist or you do not have permission to access it.";
			errorDetails =
				"Please verify the parent record ID and ensure you have access to this instance's data.";
			break;

		case "no-tenant":
			errorTitle = "No Country Instance Selected";
			errorMessage =
				"Your account is not associated with any country instance.";
			errorDetails =
				"Please contact your administrator or technical support for assistance.";
			break;
		...
		case "access-denied":
			...
			errorDetails =
				"This file belongs to a different country instance. You can only access files that belong to your country account.";
			break;
				...
				<div className="mg-grid__col mg-grid__col--12 mg-grid__col--md-8 mg-grid__col--md-offset-2">
					<div className="mg-card mg-card--error mg-u-margin-bottom--lg">
						...
						<div className="mg-card__body">
							...
							<p className="mg-u-font-size--sm mg-u-color--gray-60">
								{errorDetails}
							</p>
						</div>
					</div>
					...
					<div className="mg-u-text-align--center mg-u-margin-top--lg">
						<a
							href="/"
							className="mg-button mg-button--primary mg-u-margin-right--md"
						>
							Return to Dashboard
						</a>
						<button
