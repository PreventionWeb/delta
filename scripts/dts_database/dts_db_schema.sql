...
--
-- Name: user_country_accounts user_country_accounts_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_country_accounts
    ADD CONSTRAINT user_country_accounts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organization(id) NOT VALID;
